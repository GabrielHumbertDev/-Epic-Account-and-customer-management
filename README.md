...
```
cd existing_repo
git remote add origin https://git.fdmgroup.com/Gabriel.Gomes/epic-account-and-customer-management2.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.fdmgroup.com/Gabriel.Gomes/epic-account-and-customer-management2/-/settings/integrations)
